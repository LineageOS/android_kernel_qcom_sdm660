...
/**
 * lock_page_memcg - lock a page->memcg_data binding
 * @page: the page
 *
...
/**
 * unlock_page_memcg - unlock a page->memcg_data binding
 * @page: the page
 */
				   ...
				   struct mem_cgroup *to)
{
	 ...
	 * page->memcg_data of its source page while we change it.
	 */
	ret = -EBUSY;
	...
	/*
	 * It is safe to change page->memcg_data here because the page
...
static void uncharge_page(struct page *page, struct uncharge_gather *ug)
{
	...
	/*
	 * Nobody should be changing or seriously looking at
	 * page->memcg_data at this point, we have fully
